...
namespace Kinematics {
    ...
    void MaslowKinematics::validateAndCorrectAnchorCoordinates() {
        ...
        float topSideLength    = sqrt((anchor_location[_TR][Coord_X] - anchor_location[_TL][Coord_X]) *
                                       (anchor_location[_TR][Coord_X] - anchor_location[_TL][Coord_X]) +
                                   (anchor_location[_TR][Coord_Y] - anchor_location[_TL][Coord_Y]) *
                                       (anchor_location[_TR][Coord_Y] - anchor_location[_TL][Coord_Y]));
        float rightSideLength  = sqrt((anchor_location[_BR][Coord_X] - anchor_location[_TR][Coord_X]) *
                                         (anchor_location[_BR][Coord_X] - anchor_location[_TR][Coord_X]) +
                                     (anchor_location[_BR][Coord_Y] - anchor_location[_TR][Coord_Y]) *
                                         (anchor_location[_BR][Coord_Y] - anchor_location[_TR][Coord_Y]));
        float bottomSideLength = sqrt((anchor_location[_BR][Coord_X] - anchor_location[_BL][Coord_X]) *
                                          (anchor_location[_BR][Coord_X] - anchor_location[_BL][Coord_X]) +
                                      (anchor_location[_BR][Coord_Y] - anchor_location[_BL][Coord_Y]) *
                                          (anchor_location[_BR][Coord_Y] - anchor_location[_BL][Coord_Y]));
        float leftSideLength   = sqrt((anchor_location[_TL][Coord_X] - anchor_location[_BL][Coord_X]) *
                                        (anchor_location[_TL][Coord_X] - anchor_location[_BL][Coord_X]) +
                                    (anchor_location[_TL][Coord_Y] - anchor_location[_BL][Coord_Y]) *
                                        (anchor_location[_TL][Coord_Y] - anchor_location[_BL][Coord_Y]));
        ...
        if (anchor_location[_TL][Coord_Y] < 0 || anchor_location[_TR][Coord_Y] < 0 ||
            ...
            anchor_location[_BL][Coord_X] < 0 || anchor_location[_BR][Coord_X] < 0 || anchor_location[_BR][Coord_X] > MAX_REASONABLE_COORD) {
