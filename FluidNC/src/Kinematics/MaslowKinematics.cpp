...
namespace Kinematics {
    ...
    namespace {
        ...
        // References registration to prevent compiler optimization from removing it
        volatile bool forceInit = (&registration, true);
    }
    ...
    void forceMaslowKinematicsRegistration() {
        // Access the dummy variable to ensure this translation unit is linked
