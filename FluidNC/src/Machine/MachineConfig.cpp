...
namespace Machine {
    ...
    void MachineConfig::groupM4Items(Configuration::HandlerBase& handler) {
        ...
        // Motor current printing control
    ...
    const std::string dcM4MotorCurrents = M + "_print_motor_currents: false\n";
    ...
    const std::string defaultConfig =
        ...
        dcM4Vert + dcM4CalibrationGrid + dcM4Anchors + dcM4ZAxis + dcM4CurrentThreshold + dcM4Thickness + dcM4MotorCurrents +
        // Default sections
